...
module Jekyll
  class JekyllSitemap < Jekyll::Generator
    ...
    def static_files
      @site.static_files.select { |file| include_static_file?(file) }
    end

    def include_static_file?(file)
      INCLUDED_EXTENSIONS.include?(file.extname) && file.defaults.fetch("sitemap", true)
    end
